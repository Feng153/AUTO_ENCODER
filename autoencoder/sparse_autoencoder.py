...
from keras.layers import Dense, Input, regularization
...
def train(x_train):
    ...
    encode_layer1 = Dense(ENCODING_DIM_LAYER1, activation='relu',
                          activity_regularizer=regularization.activity_regularization.regularizers.l1(10e-6))(
        input_image)
    ...
    autoencoder.fit(x_train, x_train, epochs=EPOCH, batch_size=BATCH_SIZE, shuffle=True)
