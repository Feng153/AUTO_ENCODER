...
class DBN:
    def __init__(self, input_size, layers, mode='bernoulli', gpu=True, k=5, savefile=None):
        self.layers = layers
    ...
    def train_DBN(self, x):
        for index, layer in enumerate(self.layers):
            ...
            rbm = RBM(vn, hn, epochs=30, mode='bernoulli', lr=0.001, k=10, batch_size=128, gpu=True, optimizer='adam',
...
if __name__ == '__main__':
    ...
    print("MAE between reconstructed and original sample:", torch.mean(torch.abs(y[1] - dataset)).item())
